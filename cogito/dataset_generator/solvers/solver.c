...
{
    "distutils": {
        "name": "scheduler.dataset_generator.solvers.solver",
        "sources": [
            "scheduler/dataset_generator/solvers/solver.py"
        ]
    },
    "module_name": "scheduler.dataset_generator.solvers.solver"
}
END: Cython Metadata */
...
#define __PYX_HAVE__scheduler__dataset_generator__solvers__solver
#define __PYX_HAVE_API__scheduler__dataset_generator__solvers__solver
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "scheduler.dataset_generator.solvers.solver" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "scheduler.dataset_generator.solvers.solver"
extern int __pyx_module_is_main_scheduler__dataset_generator__solvers__solver;
int __pyx_module_is_main_scheduler__dataset_generator__solvers__solver = 0;

/* Implementation of "scheduler.dataset_generator.solvers.solver" */
/* #### Code section: global_var ### */
static PyObject *__pyx_builtin_print;
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9scheduler_17dataset_generator_7solvers_6solver_solve(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_method, PyObject *__pyx_v_dataset); /* proto */
...
#define __pyx_kp_u_Unknown_method __pyx_string_tab[2]
#define __pyx_kp_u_Warning_CP_SAT_solver_did_not_fi __pyx_string_tab[3]
#define __pyx_kp_u__2 __pyx_string_tab[4]
#define __pyx_kp_u_add_note __pyx_string_tab[5]
#define __pyx_kp_u_list_VmAssignment __pyx_string_tab[6]
#define __pyx_kp_u_scheduler_dataset_generator_solv_3 __pyx_string_tab[7]
#define __pyx_n_u_Dataset __pyx_string_tab[8]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[9]
#define __pyx_n_u_VmAssignment __pyx_string_tab[10]
#define __pyx_n_u_assignments __pyx_string_tab[11]
...
#define __pyx_n_u_is_optimal __pyx_string_tab[17]
#define __pyx_n_u_items __pyx_string_tab[18]
#define __pyx_n_u_main __pyx_string_tab[19]
#define __pyx_n_u_method __pyx_string_tab[20]
...
#define __pyx_n_u_sat __pyx_string_tab[27]
#define __pyx_n_u_scheduler_dataset_generator_core __pyx_string_tab[28]
#define __pyx_n_u_scheduler_dataset_generator_solv __pyx_string_tab[29]
#define __pyx_n_u_scheduler_dataset_generator_solv_2 __pyx_string_tab[30]
#define __pyx_n_u_set_name __pyx_string_tab[31]
#define __pyx_n_u_setdefault __pyx_string_tab[32]
#define __pyx_n_u_solve __pyx_string_tab[33]
#define __pyx_n_u_solve_cp_sat __pyx_string_tab[34]
...
#define __pyx_n_u_vms __pyx_string_tab[38]
#define __pyx_n_u_workflows __pyx_string_tab[39]
#define __pyx_kp_b_iso88591_A_wc_N_az_DPWWX_4q_q_A __pyx_string_tab[40]
...
/* "scheduler/dataset_generator/solvers/solver.py":5
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_9scheduler_17dataset_generator_7solvers_6solver_1solve(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_9scheduler_17dataset_generator_7solvers_6solver_1solve = {"solve", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9scheduler_17dataset_generator_7solvers_6solver_1solve, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9scheduler_17dataset_generator_7solvers_6solver_1solve(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_method,&__pyx_mstate_global->__pyx_n_u_dataset,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "solve", 0) < (0)) __PYX_ERR(0, 5, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("solve", 1, 2, 2, i); __PYX_ERR(0, 5, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("solve", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("scheduler.dataset_generator.solvers.solver.solve", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_method), (&PyUnicode_Type), 0, "method", 2))) __PYX_ERR(0, 5, __pyx_L1_error)
  __pyx_r = __pyx_pf_9scheduler_17dataset_generator_7solvers_6solver_solve(__pyx_self, __pyx_v_method, __pyx_v_dataset);
...
static PyObject *__pyx_pf_9scheduler_17dataset_generator_7solvers_6solver_solve(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_method, PyObject *__pyx_v_dataset) {
  ...
  /* "scheduler/dataset_generator/solvers/solver.py":6
 * 
 * def solve(method: str, dataset: Dataset) -> list[VmAssignment]:
 *     if method == "sat":             # <<<<<<<<<<<<<<
 *         is_optimal, assignments = solve_cp_sat(workflows=dataset.workflows, vms=dataset.vms)
 *         if not is_optimal:
*/
  __pyx_t_1 = (__Pyx_PyUnicode_Equals(__pyx_v_method, __pyx_mstate_global->__pyx_n_u_sat, Py_EQ)); if (unlikely((__pyx_t_1 < 0))) __PYX_ERR(0, 6, __pyx_L1_error)
  if (__pyx_t_1) {

    /* "scheduler/dataset_generator/solvers/solver.py":7
 * def solve(method: str, dataset: Dataset) -> list[VmAssignment]:
 *     if method == "sat":
 *         is_optimal, assignments = solve_cp_sat(workflows=dataset.workflows, vms=dataset.vms)             # <<<<<<<<<<<<<<
 *         if not is_optimal:
...
*/
    __pyx_t_3 = NULL;
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_solve_cp_sat); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 7, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_dataset, __pyx_mstate_global->__pyx_n_u_workflows); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 7, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_v_dataset, __pyx_mstate_global->__pyx_n_u_vms); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 7, __pyx_L1_error)
    ...
    #endif
    {
      ...
      __pyx_t_8 = __Pyx_MakeVectorcallBuilderKwds(2); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 7, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_workflows, __pyx_t_5, __pyx_t_8, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 7, __pyx_L1_error)
      if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_vms, __pyx_t_6, __pyx_t_8, __pyx_callargs+1, 1) < (0)) __PYX_ERR(0, 7, __pyx_L1_error)
    ...
    if ((likely(PyTuple_CheckExact(__pyx_t_2))) || (PyList_CheckExact(__pyx_t_2))) {
      ...
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_8 = __Pyx_PySequence_ITEM(sequence, 1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 7, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      #endif
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    } else {
      Py_ssize_t index = -1;
      __pyx_t_6 = PyObject_GetIter(__pyx_t_2); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 7, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      ...
      __Pyx_GOTREF(__pyx_t_8);
      if (__Pyx_IternextUnpackEndCheck(__pyx_t_9(__pyx_t_6), 2) < (0)) __PYX_ERR(0, 7, __pyx_L1_error)
      __pyx_t_9 = NULL;
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    ...
    __pyx_v_is_optimal = __pyx_t_4;
    __pyx_t_4 = 0;
    __pyx_v_assignments = __pyx_t_8;
    __pyx_t_8 = 0;

    /* "scheduler/dataset_generator/solvers/solver.py":8
 *     if method == "sat":
 *         is_optimal, assignments = solve_cp_sat(workflows=dataset.workflows, vms=dataset.vms)
 *         if not is_optimal:             # <<<<<<<<<<<<<<
 *             print("Warning: CP-SAT solver did not find an optimal solution.")
 *         return assignments
*/
    __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_v_is_optimal); if (unlikely((__pyx_t_1 < 0))) __PYX_ERR(0, 8, __pyx_L1_error)
    __pyx_t_10 = (!__pyx_t_1);
    if (__pyx_t_10) {

      /* "scheduler/dataset_generator/solvers/solver.py":9
 *         is_optimal, assignments = solve_cp_sat(workflows=dataset.workflows, vms=dataset.vms)
 *         if not is_optimal:
 *             print("Warning: CP-SAT solver did not find an optimal solution.")             # <<<<<<<<<<<<<<
 *         return assignments
...
*/
      ...
      __pyx_t_7 = 1;
      {
        PyObject *__pyx_callargs[2] = {__pyx_t_8, __pyx_mstate_global->__pyx_kp_u_Warning_CP_SAT_solver_did_not_fi};
...
*/
    ...
    /* "scheduler/dataset_generator/solvers/solver.py":10
 *         if not is_optimal:
 *             print("Warning: CP-SAT solver did not find an optimal solution.")
 *         return assignments             # <<<<<<<<<<<<<<
 * 
...
*/
    ...
    __pyx_t_2 = __pyx_v_assignments;
    __Pyx_INCREF(__pyx_t_2);
    if (!(likely(PyList_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None) || __Pyx_RaiseUnexpectedTypeError("list", __pyx_t_2))) __PYX_ERR(0, 10, __pyx_L1_error)
...
*/
  ...
  /* "scheduler/dataset_generator/solvers/solver.py":12
 *         return assignments
 * 
 *     raise ValueError(f"Unknown method: {method}")             # <<<<<<<<<<<<<<
*/
  __pyx_t_8 = NULL;
  __pyx_t_4 = __Pyx_PyUnicode_Concat(__pyx_mstate_global->__pyx_kp_u_Unknown_method, __pyx_v_method); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_7 = 1;
  {
...
__Pyx_RefNannySetupContext("PyInit_solver", 0);
  ...
  if (__pyx_module_is_main_scheduler__dataset_generator__solvers__solver) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "scheduler.dataset_generator.solvers.solver")) {
      if (unlikely((PyDict_SetItemString(modules, "scheduler.dataset_generator.solvers.solver", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "scheduler/dataset_generator/solvers/solver.py":1
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_Dataset,__pyx_mstate_global->__pyx_n_u_VmAssignment};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_scheduler_dataset_generator_core, __pyx_imported_names, 2, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
  ...
  /* "scheduler/dataset_generator/solvers/solver.py":2
 * from scheduler.dataset_generator.core.models import Dataset, VmAssignment
 * from scheduler.dataset_generator.solvers.cp_sat_solver import solve_cp_sat             # <<<<<<<<<<<<<<
 * 
 * 
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_solve_cp_sat};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_scheduler_dataset_generator_solv, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_method, __pyx_mstate_global->__pyx_n_u_str) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_dataset, __pyx_mstate_global->__pyx_n_u_Dataset) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_return, __pyx_mstate_global->__pyx_kp_u_list_VmAssignment) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_9scheduler_17dataset_generator_7solvers_6solver_1solve, 0, __pyx_mstate_global->__pyx_n_u_solve, NULL, __pyx_mstate_global->__pyx_n_u_scheduler_dataset_generator_solv_2, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_solve, __pyx_t_4) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init scheduler.dataset_generator.solvers.solver", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init scheduler.dataset_generator.solvers.solver");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{179},{16},{56},{1},{8},{18},{45},{7},{20},{12},{11},{18},{18},{7},{8},{13},{10},{5},{8},{6},{10},{8},{3},{5},{12},{6},{3},{39},{49},{42},{12},{10},{5},{12},{3},{8},{6},{3},{9},{72}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (597 bytes) */
const char* const cstring = "BZh91AY&SY7\250\344H\000\000\"\177\377d\334\266\200`\327\204P\257!_\312\277\377\377\360@@@\000@@\000@@@@@@\000@\001\352\340\005\210\251\372j4h\202mL\006\221\223\021\200\214\010\362\2150OC\324\230\332j\021S\3114h\362\2154h\3024\310\000\003\004\320\006\203LC@8\311\223F!\246\206\002hbh\323& da4i\246\020d\302Q\000@\t\246\201O(z\200d\000\000\000\017S\320AX\372\310\266\215(Ph\344)\252\007I\331!\266\230\255D\306\257o\324\246\343\215\2076\316N\221\270\301\330\340\341\363\314\031\307\025\036\270p}\257\260\t:\331h\3234r\214\020\304\005\020\304\316\222$z\nn\214\ty\020H?P \272\206\241\201\233G\n\357@\215\376m7/r\001\301Q\200\302\377\"*\366*\035\221\362\0213$r\001\214\006=\315NaG,E\217\357\343\261;\237>\211'\3631\313\232\261,\345\031tW\353\202\027\275A\306\235\371\3578\333w\031\003\031\220\335\272TX\223;\262j\267\220\273\236I\370\253\013\"\242\3101v\253q\313b:\335\257\347\242\200\177\014\031\006T\252?\276\024\245.\251\030\253\242`\300\260\3525\260\324\364\t\025p\303\205\346:vV(kJ\323@(a\272\274\256K\340\232\250\3357\031\353\242\247\024\333;\246=\220\214\251iR\017b\264\251Yk\333\200\203\270\225@zM+v\325\216\210O\245\216\233\224_m\362\257\307\t-K0T\277\233jB\027Q\2523\232\231\306n6\223\326 \327\032\335DCVu+6\256\026\014\305\344\336O*T\322\335\346\003\224\024U[\005A\226\316\017\223\361\320